...
export function renderMemeThumbnail(post) {
  ...
  postElement.innerHTML = `
      ...
      <button class="edit-button mt-4 mb-4 px-4 py-2 bg-green-600 hover:bg-green-500 text-white font-semibold rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 transition duration-300">Edit</button>
      <button class="delete-button mt-4 mb-4 px-4 py-2 bg-red-500 hover:bg-red-500 text-white font-semibold rounded-lg focus:outline-none focus:ring-2 focus:ring-red-400 transition duration-300">Delete</button>
    `;
